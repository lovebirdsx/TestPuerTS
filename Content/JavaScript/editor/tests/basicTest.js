...
function basicTest() {
    ...
    const str2 = UE.JSBlueprintFunctionLibrary.Concat(', ', str1);
    ...
    const actor = UE.GameplayStatics.BeginDeferredActorSpawnFromClass(gameInstance, UE.MainActor.StaticClass(), undefined);
    ...
    const strRef = (0, puerts_1.$ref)('666');
    actor.NotifyWithRefString.Execute(strRef);
    console.log('out str:' + (0, puerts_1.$unref)(strRef));
    const retStr = actor.NotifyWithStringRet.Execute("console.log('hello world')");
    ...
    //unhandledRejection
    (0, puerts_1.on)('unhandledRejection', function (_reason) {
