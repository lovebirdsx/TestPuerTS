...
export class NodeIPCServer extends IPCServer {
	...
	constructor(server: NetServer) {
		super(NodeIPCServer.toClientConnectionEvent(server));
		this.server = server;
	}
...
export function serve(port: number): Promise<NodeIPCServer>;
export function serve(namedPipe: string): Promise<NodeIPCServer>;
export function serve(hook: any): Promise<NodeIPCServer> {
	return new Promise<NodeIPCServer>((c, e) => {
...
export function connect(options: { host: string; port: number }, clientId: string): Promise<NetIPCClient>;
export function connect(port: number, clientId: string): Promise<NetIPCClient>;
export function connect(namedPipe: string, clientId: string): Promise<NetIPCClient>;
export function connect(hook: any, clientId: string): Promise<NetIPCClient> {
	return new Promise<NetIPCClient>((c, e) => {
